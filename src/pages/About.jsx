  ...
  return (
    <div>
     ...
     <div className="mt-32">
        ...
        <div className="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-2xl text-center">
          <h2 className="text-3xl font-bold text-gray-800 mb-6">About Our Asset Management System</h2>
